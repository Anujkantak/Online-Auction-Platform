...
const PaymentProofs = () => {
  ...
  return (
    <>
      ...
      {openDrawer ? <Drawer setOpenDrawer={setOpenDrawer} openDrawer={openDrawer} /> : null}
...
export const Drawer = ({ setOpenDrawer, openDrawer }) => {
  ...
  const handlePaymentProofUpdate = () => {
    ...
    setAmount("");
    setStatus("");
    dispatch(getSinglePaymentProofDetail({}));
    // Reset singlePaymentProof to an empty object after update
    // dispatch(getSinglePaymentProofDetail({})); 
  };
