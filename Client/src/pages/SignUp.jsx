...
const SignUp = () => {
  ...
  const [upi_number, setUpi_number] = useState("");
  ...
  const handleRegister = (e) => {
    ...
    role === "Auctioneer" &&
      ...
      formData.append("upi_number", upi_number),
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="HBL">Union Bank of India</option>
                    <option value="Allied Bank">Allahabad Bank</option>
                  </select>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <input
                    type="number"
                    value={upi_number}
                    placeholder="Gpay/Paytm/PhonePe UPI ID"
                    onChange={(e) => setUpi_number(e.target.value)}
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1"
                    disabled={role === "Bidder"}
                  />
                  <input
