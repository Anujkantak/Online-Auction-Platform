...
const UpcomingAuctions = () => {
  ...
  // Get today's date as a string in the format "Mon Jan 01 2023"
  const todayString = today.toDateString();

  const auctionsStartingToday = allAuctions.filter((item) => {
    const auctionDate = new Date(item.startTime);// Convert the startTime to a Date object
    // Compare the auction date with today's date
    // toDateString() returns a string representation of the date in the format "Mon Jan
